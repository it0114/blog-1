window.onload = function () {
    ...
    submit.onclick = function () {
        ...
        if (textarea.length === 0 || name.length === 0) {
            ...
            my_textarea.style.border = " 1px solid red";
            my_textarea.value = "";
        ...
        li.innerHTML = "<div>" + "<i>" + nameColor + "</i>" + "<span>" + num++ + "楼" + "</span>" + "<h4><a href='javascript:;'>" + name + "</a></h4><span>" + formartDate() + "</span></div>" + "<p>" + textarea + "</p>";
